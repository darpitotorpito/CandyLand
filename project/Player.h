...
private:
    ...
    string _character_name;                   // The name of the character currently in use by the player
    int _player_number;                       // The numeric value assigned to the player
...
public:
    ...
    // Member Functions
    void setPlayerCharacter(Character selected_character); // Sets the values of the character to the player.
